...
#pragma region init
	...
	{
		std::cout << "err initializing glad";
	}
...
#pragma endregion
	...
	renderer.init(w, h, RESOURCES_PATH "BRDFintegrationMap.png");


	renderer.colorCorrectionTexture() = renderer.loadColorLookupTextureFromFile(RESOURCES_PATH "testLut.png");
	//renderer.colorCorrection.currentTexture = renderer.loadColorLookupTextureFromFile(RESOURCES_PATH "neutral-lut.png");

	{//load
		std::ifstream f(RESOURCES_PATH "save.txt");
		if (f.is_open())
		{
...
#pragma region shader
	gl3d::Shader shader;
	shader.loadShaderProgramFromFile(SHADERS_PATH "color.vert", SHADERS_PATH "color.frag",
	...
	//showNormalsShader.loadShaderProgramFromFile(SHADERS_PATH"showNormals.vert",
	//	SHADERS_PATH"showNormals.geom", SHADERS_PATH"showNormals.frag");
...
#pragma region texture
	...
	//gl3d::Texture crateTexture(RESOURCES_PATH"other/crate.png");
	//gl3d::Texture crateNormalTexture(RESOURCES_PATH"other/crateNormal.png");
	//gl3d::Texture rockTexture(RESOURCES_PATH"other/boulder.png");
	//gl3d::Texture rockNormalTexture(RESOURCES_PATH"other/boulderNormal.png");

	//gl3d::Texture levelTexture(RESOURCES_PATH"obj/level.png");
...
#pragma endregion
	...
	//renderer.skyBox = renderer.loadHDRSkyBox(RESOURCES_PATH "skyBoxes/WinterForest_Ref.hdr");
	//renderer.skyBox = renderer.loadHDRSkyBox(RESOURCES_PATH "skyBoxes/Newport_Loft_Ref.hdr");
	//renderer.skyBox = renderer.loadHDRSkyBox(RESOURCES_PATH "skyBoxes/bell_park_dawn_1k.hdr");
	//renderer.skyBox = renderer.loadHDRSkyBox(RESOURCES_PATH "skyBoxes/Milkyway_small.hdr");
	//renderer.skyBox = renderer.loadHDRSkyBox(RESOURCES_PATH "skyBox.hdr");
	//renderer.skyBox = renderer.loadHDRSkyBox(RESOURCES_PATH "skyBoxes/canary_wharf_2k.hdr");
	//renderer.skyBox = renderer.loadHDRSkyBox(RESOURCES_PATH "skyBoxes/chinese_garden_2k.hdr");
	...
	//skyBox.loadTexture(RESOURCES_PATH "skyBoxes/ocean_1.png");
	//renderer.skyBox = renderer.loadHDRSkyBox(RESOURCES_PATH "skyBoxes/chinese_garden_2k.hdr");
	//renderer.skyBox = renderer.loadSkyBox(RESOURCES_PATH "skyBoxes/sky.png", 0);
	//renderer.skyBox = renderer.loadSkyBox(RESOURCES_PATH "skyBoxes/forest.png", 0);
	...
	//auto materials = renderer.loadMaterial(RESOURCES_PATH "materials/adventurer/adventurer.mtl");
	//auto materials = renderer.loadMaterial(RESOURCES_PATH "materials/ironMan/ironMan.mtl");


	//auto levelModel = renderer.loadModel(RESOURCES_PATH "donut/Donut.glb", 0, 1.f);
	//auto levelModel = renderer.loadModel(RESOURCES_PATH "mutant/Biomech_Mutant_Skin_1.gltf", 0, 1.f);
	//auto barelModel = renderer.loadModel(RESOURCES_PATH "wine/wine_barrel_01_2k.gltf", 0, 1);
	//auto rockModel = renderer.loadModel(RESOURCES_PATH "mutant/2/Biomech_Mutant_Skin_2.gltf", 0, 1.f);
	//auto rockModel = renderer.loadModel(RESOURCES_PATH "amogus.glb", 0, 1.f);
	//auto rockModel = renderer.loadModel(RESOURCES_PATH "animatedModels/arrow.glb", 0,  1.f);
	//auto sphereModel = renderer.loadModel(RESOURCES_PATH "knight/uploads_files_1950170_Solus_the_knight.gltf", gl3d::TextureLoadQuality::maxQuality, 1.f);
	//auto rockModel = renderer.loadModel(RESOURCES_PATH "steve.glb", gl3d::TextureLoadQuality::leastPossible, 1.f);
	//auto rockModel = renderer.loadModel(RESOURCES_PATH "animatedSteve/scene.gltf", 0, 1.f);
	auto sphereModel = renderer.loadModel(RESOURCES_PATH "diamond.glb", 0, 0.1);
	//auto levelModel = renderer.loadModel(RESOURCES_PATH "gltf/steve.glb", 0);
	//auto levelModel = renderer.loadModel(RESOURCES_PATH "gltf/boomBox/BoomBox.gltf");
	//auto levelModel = renderer.loadModel(RESOURCES_PATH "gltf/jack.glb", gl3d::TextureLoadQuality::maxQuality, 1);
	//auto levelModel = renderer.loadModel(RESOURCES_PATH "obj/jack/untitled.obj", 0, 1);
	auto levelModel = renderer.loadModel(RESOURCES_PATH "sponza2/sponza.obj", gl3d::TextureLoadQuality::maxQuality, 0.008);
	...
	//auto sphereModel = renderer.loadModel(RESOURCES_PATH "sponza2/sponza.obj", gl3d::TextureLoadQuality::maxQuality, 0.008);
	//auto sphereModel = renderer.loadModel(RESOURCES_PATH "katana/antique_katana_01_1k.gltf");
	//auto rockModel = renderer.loadModel(RESOURCES_PATH "mutant/Biomech_Mutant_Skin_1.glb",0,  1.f);

	//auto barelModel = renderer.loadModel(RESOURCES_PATH "barrel/Barrel_01.obj", gl3d::TextureLoadQuality::maxQuality, 1);
	//auto barelModel = renderer.loadModel(RESOURCES_PATH "obj/AMG/AMG2.obj");
	//auto barelModel = renderer.loadModel(RESOURCES_PATH "obj/backpack/backpack.obj");
	//auto rockModel = renderer.loadModel(RESOURCES_PATH "helmet/helmet.obj", 0, 1);
	//auto rockModel = renderer.loadObject(RESOURCES_PATH "other/boulder.obj",0, 0.1);
	//auto levelModel = renderer.loadModel(RESOURCES_PATH "city/city.obj",0, 0.01);
	//auto levelModel = renderer.loadModel(RESOURCES_PATH "sponza/sponza.obj");
	//auto rockModel = renderer.loadModel(RESOURCES_PATH "other/crate.obj",0, 0.01);
	auto rockModel = renderer.loadModel(RESOURCES_PATH "obj/sphere2.obj", gl3d::TextureLoadQuality::maxQuality, 1.f);
	//auto levelModel = renderer.loadModel(RESOURCES_PATH "planeta.glb");
	//auto sphereModel = renderer.loadModel(RESOURCES_PATH "obj/sphere2.obj");
	//auto sphereModel = renderer.loadModel(RESOURCES_PATH "birb.glb");
	//auto levelModel = renderer.loadModel(RESOURCES_PATH "obj/sphere.obj");
	//auto rockModel = renderer.loadModel(RESOURCES_PATH "obj/sphere.obj");
	auto barelModel = renderer.loadModel(RESOURCES_PATH "obj/sphere.obj", gl3d::TextureLoadQuality::maxQuality, 1.f);
	...
	//auto objectTest = renderer.loadObject(RESOURCES_PATH "other/crate.obj", 0.01);
	//auto objectTest = renderer.loadObject(RESOURCES_PATH "sponza2/sponza.obj", 0.008);


	//auto objectTest = renderer.loadObject(RESOURCES_PATH "barrel/Barrel_01.obj");
	//auto objectTest2 = renderer.loadObject(RESOURCES_PATH "other/crate.obj", 0.01);
